...
"
"       For those not found on github and change for my personal use,
"       here is my github for vim-plugins: https://www.github.com/vimplugin.
"       NO guaranty with the latest update
" Section:
"
" => Text Thinking -------------------------------------------------------- {{{
" Working with wiki
...
call AddBundle('vimplugin/pydiction')   " No +python complied needed
try
...
" => Utility -------------------------------------------------------------- {{{
" Pending tasks list
call AddBundle('vimplugin/fixedtasklist')
...
call AddBundle('vimplugin/molokai')
try
    colorscheme molokai
catch
endtry
...
call AddBundle('vimplugin/showmarks')
try
    " mark z is not used
